...
const QuillEditor: React.FC<QuillEditorProps> = ({
  ...
  }, [dirType, dirDetails.title, dirDetails.iconId, dirDetails.createdAt, dirDetails.data, dirDetails.inTrash, dirDetails.bannerUrl, state.workspaces, workspaceId, folderId, fileId]);
